...
import babyKidsHeroImg from '../assets/Images/Occasions/BabyKids/HeroBG.webp';
import babyKidsDetailImg from '../assets/Images/Occasions/BabyKids/DetailBG.webp';
import idea1 from '../assets/Images/Occasions/BabyKids/1.webp';
import idea2 from '../assets/Images/Occasions/BabyKids/2.webp';
import idea3 from '../assets/Images/Occasions/BabyKids/3.webp';
import idea4 from '../assets/Images/Occasions/BabyKids/4.webp';
import idea5 from '../assets/Images/Occasions/BabyKids/5.webp';
import idea6 from '../assets/Images/Occasions/BabyKids/6.webp';
import idea7 from '../assets/Images/Occasions/BabyKids/7.webp';
import idea8 from '../assets/Images/Occasions/BabyKids/8.webp';
import idea9 from '../assets/Images/Occasions/BabyKids/9.webp';
import idea10 from '../assets/Images/Occasions/BabyKids/10.webp';
import idea11 from '../assets/Images/Occasions/BabyKids/11.webp';
import idea12 from '../assets/Images/Occasions/BabyKids/12.webp';
import { FaMapMarkerAlt, FaTag, FaRegLightbulb, FaInfoCircle } from 'react-icons/fa';

const babyKidsPlans = [
  {
    name: "Insta Baby Shoot",
      ...
      <div className="flex flex-col gap-4 md:gap-32">
        <section id="pricing-plans" className="w-full scroll-mt-40 flex flex-col items-center">
          ...
          <div className="w-full max-w-[1600px] mx-auto px-4 lg:px-8">
            <PricingAccordion plans={babyKidsPlans} serviceName="Baby & Kids" />
          </div>
        </section>
        ...
        <section id="details" className="relative w-full h-[50vh] md:h-[55vh] flex items-center justify-center mt-0 md:-mt-20 overflow-hidden scroll-mt-40 z-10">
          <div className="absolute inset-0 w-full h-full bg-black">
            <img loading="lazy" src={babyKidsDetailImg} alt="Baby Kids Background" className="w-full h-full object-cover opacity-50 transition-transform duration-[10000ms] scale-110 hover:scale-100" />
          </div>
