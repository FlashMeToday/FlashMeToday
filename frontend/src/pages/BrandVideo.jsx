...
import brandVideoHeroImg from '../assets/Images/Business/BrandVideo/HeroBG.webp';
import brandVideoDetailImg from '../assets/Images/Business/BrandVideo/DetailBG.webp';
import idea1 from '../assets/Images/Business/BrandVideo/1.webp';
import idea2 from '../assets/Images/Business/BrandVideo/2.webp';
import idea3 from '../assets/Images/Business/BrandVideo/3.webp';
import idea4 from '../assets/Images/Business/BrandVideo/4.webp';
import idea5 from '../assets/Images/Business/BrandVideo/5.webp';
import idea6 from '../assets/Images/Business/BrandVideo/6.webp';
import idea7 from '../assets/Images/Business/BrandVideo/7.webp';
import idea8 from '../assets/Images/Business/BrandVideo/8.webp';
import idea9 from '../assets/Images/Business/BrandVideo/9.webp';
import idea10 from '../assets/Images/Business/BrandVideo/10.webp';
import idea11 from '../assets/Images/Business/BrandVideo/11.webp';
import idea12 from '../assets/Images/Business/BrandVideo/12.webp';
      ...
      <div className="flex flex-col gap-4 md:gap-32">
        ...
        <section id="details" className="relative w-full h-[50vh] md:h-[55vh] flex items-center justify-center mt-0 md:-mt-20 overflow-hidden scroll-mt-40 z-10">
          <div className="absolute inset-0 w-full h-full bg-black">
            <img loading="lazy" src={brandVideoDetailImg} alt="Brand Video Background" className="w-full h-full object-cover opacity-50 transition-transform duration-[10000ms] scale-110 hover:scale-100" />
          </div>
