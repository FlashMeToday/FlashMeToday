...
import foodHeroImg from '../assets/Images/Business/Food/HeroBG.webp';
import foodDetailImg from '../assets/Images/Business/Food/DetailBG.webp';
import idea1 from '../assets/Images/Business/Food/1.webp';
import idea2 from '../assets/Images/Business/Food/2.webp';
import idea3 from '../assets/Images/Business/Food/3.webp';
import idea4 from '../assets/Images/Business/Food/4.webp';
import idea5 from '../assets/Images/Business/Food/5.webp';
import idea6 from '../assets/Images/Business/Food/6.webp';
import idea7 from '../assets/Images/Business/Food/7.webp';
import idea8 from '../assets/Images/Business/Food/8.webp';
import idea9 from '../assets/Images/Business/Food/9.webp';
import idea10 from '../assets/Images/Business/Food/10.webp';
import idea11 from '../assets/Images/Business/Food/11.webp';
import idea12 from '../assets/Images/Business/Food/12.webp';
import { FaMapMarkerAlt, FaTag, FaRegLightbulb, FaInfoCircle } from 'react-icons/fa';

const foodPlans = [
  {
    name: "Insta Food Shoot",
  ...
  {
    name: "Grand Food Shoot",
    description: "Photos + Reels",
    features: [
      "15 Dishes",
      "3 Exclusive Shots Per Dish",
      ...
      <div className="flex flex-col gap-4 md:gap-32">
        <section id="pricing-plans" className="w-full scroll-mt-40 flex flex-col items-center">
          ...
          <div className="w-full max-w-[1600px] mx-auto px-4 lg:px-8">
            <PricingAccordion plans={foodPlans} serviceName="Food" />
          </div>
        </section>
        ...
        <section id="details" className="relative w-full h-[50vh] md:h-[55vh] flex items-center justify-center mt-0 md:-mt-20 overflow-hidden scroll-mt-40 z-10">
          <div className="absolute inset-0 w-full h-full bg-black">
            <img loading="lazy" src={foodDetailImg} alt="Food Background" className="w-full h-full object-cover opacity-50 transition-transform duration-[10000ms] scale-110 hover:scale-100" />
          </div>
          ...
          <div className="relative z-10 max-w-5xl mx-auto px-4 lg:px-8 text-center flex flex-col items-center justify-center h-full">
            ...
            <div className="relative">
              ...
              <p className="text-gray-200 text-lg md:text-2xl font-sans font-light leading-relaxed mb-4 drop-shadow-md">
                Food photography is all about making flavors visible and irresistible. Unlike a written menu, professional food images bring dishes to life by highlighting their texture, color, and freshness.
              </p>
              <p className="text-gray-300 text-xs md:text-sm font-sans font-light tracking-widest uppercase leading-loose max-w-3xl mx-auto">
                Every detail, from plating and lighting to composition, plays a crucial role in creating visuals that look as good as the food tastes.
              </p>
