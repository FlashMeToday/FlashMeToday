...
import profileHeadshotHeroImg from '../assets/Images/Business/ProfileHeadshot/HeroBG.webp';
import profileHeadshotDetailImg from '../assets/Images/Business/ProfileHeadshot/DetailBG.webp';
import idea1 from '../assets/Images/Business/ProfileHeadshot/1.webp';
import idea2 from '../assets/Images/Business/ProfileHeadshot/2.webp';
import idea3 from '../assets/Images/Business/ProfileHeadshot/3.webp';
import idea4 from '../assets/Images/Business/ProfileHeadshot/4.webp';
import idea5 from '../assets/Images/Business/ProfileHeadshot/5.webp';
import idea6 from '../assets/Images/Business/ProfileHeadshot/6.webp';
import idea7 from '../assets/Images/Business/ProfileHeadshot/7.webp';
import idea8 from '../assets/Images/Business/ProfileHeadshot/8.webp';
import idea9 from '../assets/Images/Business/ProfileHeadshot/9.webp';
import idea10 from '../assets/Images/Business/ProfileHeadshot/10.webp';
import idea11 from '../assets/Images/Business/ProfileHeadshot/11.webp';
import idea12 from '../assets/Images/Business/ProfileHeadshot/12.webp';
import { FaMapMarkerAlt, FaTag, FaRegLightbulb, FaInfoCircle } from 'react-icons/fa';

const profileHeadshotPlans = [
  {
    name: "Corporate Profile & Headshot",
    description: "20 Edited Profile Images combination of Full Length & Headshots",
    features: [
      "2 Location",
      "2 Dress Change",
      "4 Hours of Shoot"
  ...
  {
    name: "Politician Profile & Headshot",
    description: "20 Edited Profile Images combination of Full Length & Headshots",
    features: [
      "2 Location",
      "4 Dress Change",
...
const ProfileHeadshot = () => {
  return (
    <ServicePageLayout
      heroImage={profileHeadshotHeroImg}
      title="Profile & Headshot"
      subtitle="First impression is the last impression! We make content that lasts."
      menuItems={[
      ...
      <div className="flex flex-col gap-4 md:gap-32">
        <section id="pricing-plans" className="w-full scroll-mt-40 flex flex-col items-center">
          ...
          <div className="w-full max-w-[1600px] mx-auto px-4 lg:px-8">
            <PricingAccordion plans={profileHeadshotPlans} serviceName="Profile & Headshots" />
          </div>
        </section>
        ...
        <section id="details" className="relative w-full h-[50vh] md:h-[55vh] flex items-center justify-center mt-0 md:-mt-20 overflow-hidden scroll-mt-40 z-10">
          <div className="absolute inset-0 w-full h-full bg-black">
            <img loading="lazy" src={profileHeadshotDetailImg} alt="Profile & Headshot Background" className="w-full h-full object-cover opacity-50 transition-transform duration-[10000ms] scale-110 hover:scale-100" />
          </div>
          ...
          <div className="relative z-10 max-w-5xl mx-auto px-4 lg:px-8 text-center flex flex-col items-center justify-center h-full">
            ...
            <div className="relative">
              ...
              <p className="text-gray-200 text-lg md:text-2xl font-sans font-light leading-relaxed mb-4 drop-shadow-md">
                A professional headshot or profile photo is more than just a picture — it’s your personal brand identity. Whether for LinkedIn, company websites, or portfolios, a high-quality headshot communicates confidence, approachability, and professionalism.
              </p>
              <p className="text-gray-300 text-xs md:text-sm font-sans font-light tracking-widest uppercase leading-loose max-w-3xl mx-auto">
                Unlike casual photos, a well-shot profile image uses proper lighting, background, and composition to reflect your personality and strengths.
              </p>
