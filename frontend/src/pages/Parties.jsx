...
import partiesHeroImg from '../assets/Images/Occasions/Parties/HeroBG.webp';
import partiesDetailImg from '../assets/Images/Occasions/Parties/DetailBG.webp';
import idea1 from '../assets/Images/Occasions/Parties/1.webp';
import idea2 from '../assets/Images/Occasions/Parties/2.webp';
import idea3 from '../assets/Images/Occasions/Parties/3.webp';
import idea4 from '../assets/Images/Occasions/Parties/4.webp';
import idea5 from '../assets/Images/Occasions/Parties/5.webp';
import idea6 from '../assets/Images/Occasions/Parties/6.webp';
import idea7 from '../assets/Images/Occasions/Parties/7.webp';
import idea8 from '../assets/Images/Occasions/Parties/8.webp';
import idea9 from '../assets/Images/Occasions/Parties/9.webp';
import idea10 from '../assets/Images/Occasions/Parties/10.webp';
import idea11 from '../assets/Images/Occasions/Parties/11.webp';
import idea12 from '../assets/Images/Occasions/Parties/12.webp';
import { FaMapMarkerAlt, FaTag, FaRegLightbulb, FaInfoCircle } from 'react-icons/fa';

const partiesPlans = [
  {
    name: "Insta Parties Shoot",
    ...
    equipment: "1 Photographer with Full Frame Cameras & Lenses",
    originalPrice: "9,999",
    offerPrice: "7,999"
  },
  {
    name: "Grand Parties Shoot",
    description: "Photos + Reels",
    features: [
      "1 Locations",
      "4 Hours Shoots",
      "200 Edited Images + 2 Reels"
    ],
    equipment: "1 Photographer with Full Frame Cameras & Lenses",
      ...
      <div className="flex flex-col gap-4 md:gap-32">
        <section id="pricing-plans" className="w-full scroll-mt-40 flex flex-col items-center">
          ...
          <div className="w-full max-w-[1600px] mx-auto px-4 lg:px-8">
            <PricingAccordion plans={partiesPlans} serviceName="Parties" />
          </div>
        </section>
        ...
        <section id="details" className="relative w-full h-[50vh] md:h-[55vh] flex items-center justify-center mt-0 md:-mt-20 overflow-hidden scroll-mt-40 z-10">
          <div className="absolute inset-0 w-full h-full bg-black">
            <img loading="lazy" src={partiesDetailImg} alt="Parties Background" className="w-full h-full object-cover opacity-50 transition-transform duration-[10000ms] scale-110 hover:scale-100" />
          </div>
          ...
          <div className="relative z-10 max-w-5xl mx-auto px-4 lg:px-8 text-center flex flex-col items-center justify-center h-full">
            ...
            <div className="relative">
              ...
              <p className="text-gray-200 text-lg md:text-2xl font-sans font-light leading-relaxed mb-4 drop-shadow-md">
                Party photography is all about energy, fun, and memories that last a lifetime. From birthdays and anniversaries to private gatherings and grand celebrations, professional photography captures the joy of every moment.
              </p>
              <p className="text-gray-300 text-xs md:text-sm font-sans font-light tracking-widest uppercase leading-loose max-w-3xl mx-auto">
                Bringing out emotions, décor, and interactions that truly define the occasion, allowing you to relive the laughter, music, and connections long after.
              </p>
