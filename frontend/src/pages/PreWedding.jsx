...
import preWeddingHeroImg from '../assets/Images/Occasions/PreWedding/HeroBG.webp';
import preWeddingDetailImg from '../assets/Images/Occasions/PreWedding/DetailBG.webp';
import idea1 from '../assets/Images/Occasions/PreWedding/1.webp';
import idea2 from '../assets/Images/Occasions/PreWedding/2.webp';
import idea3 from '../assets/Images/Occasions/PreWedding/3.webp';
import idea4 from '../assets/Images/Occasions/PreWedding/4.webp';
import idea5 from '../assets/Images/Occasions/PreWedding/5.webp';
import idea6 from '../assets/Images/Occasions/PreWedding/6.webp';
import idea7 from '../assets/Images/Occasions/PreWedding/7.webp';
import idea8 from '../assets/Images/Occasions/PreWedding/8.webp';
import idea9 from '../assets/Images/Occasions/PreWedding/9.webp';
import idea10 from '../assets/Images/Occasions/PreWedding/10.webp';
import idea11 from '../assets/Images/Occasions/PreWedding/11.webp';
import idea12 from '../assets/Images/Occasions/PreWedding/12.webp';
import { FaMapMarkerAlt, FaTag, FaRegLightbulb, FaInfoCircle } from 'react-icons/fa';

const preWeddingPlans = [
  {
    name: "Influencer shoot",
    description: "Photography Only",
    features: [
      "30 edited images",
      "4-5 hrs shoot, 2 locations & 2 dresses changes"
    ],
    equipment: "Full Frame Camera & Lenses, lights with 1 Experienced Photographer",
  ...
  },
  {
    ...
    features: [
      "50 edited images",
      "2-3 Minutes Cinematic Video",
      "7-8 Hours Shoot with unlimited Dress Changes at Locations"
    ],
    equipment: "Full Frame Cameras, Lenses, Gimbles, lights with 2 Experienced Photographer & Helpers",
    originalPrice: "37,999",
    offerPrice: "31,999"
  },
  {
    name: "Exclusive Shoot",
    description: "Photography + Videography + Drone",
    features: [
      "60 Edited images",
      "3-4 Minute Cinematic Video",
      "1 Teaser Video",
      "8 Hours Shoot with unlimited Dress Changes at Locations"
    ],
    equipment: "Full Frame Cameras, Lenses, Gimbles, lights & Drone with 3 Experienced Photographer & Helpers",
      ...
      <div className="flex flex-col gap-4 md:gap-32">
        <section id="pricing-plans" className="w-full scroll-mt-40 flex flex-col items-center">
          ...
          <div className="w-full max-w-[1600px] mx-auto px-4 lg:px-8">
            <PricingAccordion plans={preWeddingPlans} serviceName="Pre-Wedding" />
          </div>
        </section>
        ...
        <section id="details" className="relative w-full h-[50vh] md:h-[55vh] flex items-center justify-center mt-0 md:-mt-20 overflow-hidden scroll-mt-40 z-10">
          <div className="absolute inset-0 w-full h-full bg-black">
            <img loading="lazy" src={preWeddingDetailImg} alt="Pre-Wedding Background" className="w-full h-full object-cover opacity-50 transition-transform duration-[10000ms] scale-110 hover:scale-100" />
          </div>
          ...
          <div className="relative z-10 max-w-5xl mx-auto px-4 lg:px-8 text-center flex flex-col items-center justify-center h-full">
            ...
            <div className="relative">
              ...
              <p className="text-gray-200 text-lg md:text-2xl font-sans font-light leading-relaxed mb-4 drop-shadow-md">
                Pre-wedding photography is more than just a shoot — it's the beautiful prelude to your love story told through visuals. It captures the raw chemistry, excitement, and unscripted emotions shared before the big day.
              </p>
              <p className="text-gray-300 text-xs md:text-sm font-sans font-light tracking-widest uppercase leading-loose max-w-3xl mx-auto">
                Turning fleeting glances and simple moments into timeless memories you will cherish forever.
              </p>
