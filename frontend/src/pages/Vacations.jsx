...
import vacationHeroImg from '../assets/Images/Occasions/Vacation/HeroBG.webp';
import vacationDetailImg from '../assets/Images/Occasions/Vacation/DetailBG.webp';
import idea1 from '../assets/Images/Occasions/Vacation/1.webp';
import idea2 from '../assets/Images/Occasions/Vacation/2.webp';
import idea3 from '../assets/Images/Occasions/Vacation/3.webp';
import idea4 from '../assets/Images/Occasions/Vacation/4.webp';
import idea5 from '../assets/Images/Occasions/Vacation/5.webp';
import idea6 from '../assets/Images/Occasions/Vacation/6.webp';
import idea7 from '../assets/Images/Occasions/Vacation/7.webp';
import idea8 from '../assets/Images/Occasions/Vacation/8.webp';
import idea9 from '../assets/Images/Occasions/Vacation/9.webp';
import idea10 from '../assets/Images/Occasions/Vacation/10.webp';
import idea11 from '../assets/Images/Occasions/Vacation/11.webp';
import idea12 from '../assets/Images/Occasions/Vacation/12.webp';
      ...
      <div className="flex flex-col gap-4 md:gap-32">
        <section id="pricing-plans" className="w-full scroll-mt-40 flex flex-col items-center">
          ...
          <div className="w-full max-w-[1600px] mx-auto px-4 lg:px-8">
            <PricingAccordion plans={vacationPlans} serviceName="Vacation" />
          </div>
        </section>
        ...
        <section id="details" className="relative w-full h-[50vh] md:h-[55vh] flex items-center justify-center mt-0 md:-mt-20 overflow-hidden scroll-mt-40 z-10">
          <div className="absolute inset-0 w-full h-full bg-black">
            <img loading="lazy" src={vacationDetailImg} alt="Vacation Background" className="w-full h-full object-cover opacity-50 transition-transform duration-[10000ms] scale-110 hover:scale-100" />
          </div>
          ...
          <div className="relative z-10 max-w-5xl mx-auto px-4 lg:px-8 text-center flex flex-col items-center justify-center h-full">
            ...
            <div className="relative">
              ...
              <p className="text-gray-200 text-lg md:text-2xl font-sans font-light leading-relaxed mb-4 drop-shadow-md">
                Vacation photography is about freezing the joy of travel, adventure, and discovery. Instead of missing out on moments behind the lens, professional photography allows you to live fully while your experiences are beautifully documented.
              </p>
              <p className="text-gray-300 text-xs md:text-sm font-sans font-light tracking-widest uppercase leading-loose max-w-3xl mx-auto">
                From scenic landscapes and city explorations to candid family fun, capturing emotions, details, and memories that stand the test of time.
              </p>
