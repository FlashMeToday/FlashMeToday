...
import vacationHeroImg from '../assets/Images/Occasions/Vacation/HeroBG.png';
import vacationDetailImg from '../assets/Images/Occasions/Vacation/DetailBG.png';
import idea1 from '../assets/Images/Occasions/Vacation/1.png';
import idea2 from '../assets/Images/Occasions/Vacation/2.png';
import idea3 from '../assets/Images/Occasions/Vacation/3.png';
import idea4 from '../assets/Images/Occasions/Vacation/4.png';
import idea5 from '../assets/Images/Occasions/Vacation/5.png';
import idea6 from '../assets/Images/Occasions/Vacation/6.png';
import idea7 from '../assets/Images/Occasions/Vacation/7.png';
import idea8 from '../assets/Images/Occasions/Vacation/8.png';
import idea9 from '../assets/Images/Occasions/Vacation/9.png';
import idea10 from '../assets/Images/Occasions/Vacation/10.png';
import idea11 from '../assets/Images/Occasions/Vacation/11.png';
import idea12 from '../assets/Images/Occasions/Vacation/12.png';
      ...
      <div className="flex flex-col gap-4 md:gap-32">
        ...
        <section id="details" className="relative w-full h-[50vh] md:h-[55vh] flex items-center justify-center mt-0 md:-mt-20 overflow-hidden scroll-mt-40 z-10">
          <div className="absolute inset-0 w-full h-full bg-black">
            <img src={vacationDetailImg} alt="Vacation Background" className="w-full h-full object-cover opacity-50 transition-transform duration-[10000ms] scale-110 hover:scale-100" />
          </div>
