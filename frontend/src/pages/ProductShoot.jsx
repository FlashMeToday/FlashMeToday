...
import productShootHeroImg from '../assets/Images/Business/ProductShoot/HeroBG.webp';
import productShootDetailImg from '../assets/Images/Business/ProductShoot/DetailBG.webp';
import idea1 from '../assets/Images/Business/ProductShoot/1.webp';
import idea2 from '../assets/Images/Business/ProductShoot/2.webp';
import idea3 from '../assets/Images/Business/ProductShoot/3.webp';
import idea4 from '../assets/Images/Business/ProductShoot/4.webp';
import idea5 from '../assets/Images/Business/ProductShoot/5.webp';
import idea6 from '../assets/Images/Business/ProductShoot/6.webp';
import idea7 from '../assets/Images/Business/ProductShoot/7.webp';
import idea8 from '../assets/Images/Business/ProductShoot/8.webp';
import idea9 from '../assets/Images/Business/ProductShoot/9.webp';
import idea10 from '../assets/Images/Business/ProductShoot/10.webp';
import idea11 from '../assets/Images/Business/ProductShoot/11.webp';
import idea12 from '../assets/Images/Business/ProductShoot/12.webp';
import { FaMapMarkerAlt, FaTag, FaRegLightbulb, FaInfoCircle } from 'react-icons/fa';

const productShootPlans = [
  {
    name: "White Background Shoot",
    description: "",
    features: [
      "50 Images",
      "4 clicks (Angled Shot 45°, Top Shot, Front Shot 135°)"
    ],
    equipment: "1 Photographer with Full Frame Cameras, Lenses & Lights",
      ...
      <div className="flex flex-col gap-4 md:gap-32">
        <section id="pricing-plans" className="w-full scroll-mt-40 flex flex-col items-center">
          ...
          <div className="w-full max-w-[1600px] mx-auto px-4 lg:px-8">
            <PricingAccordion plans={productShootPlans} serviceName="Product Shoot" />
          </div>
        </section>
        ...
        <section id="details" className="relative w-full h-[50vh] md:h-[55vh] flex items-center justify-center mt-0 md:-mt-20 overflow-hidden scroll-mt-40 z-10">
          <div className="absolute inset-0 w-full h-full bg-black">
            <img loading="lazy" src={productShootDetailImg} alt="Product Shoot Background" className="w-full h-full object-cover opacity-50 transition-transform duration-[10000ms] scale-110 hover:scale-100" />
          </div>
          ...
          <div className="relative z-10 max-w-5xl mx-auto px-4 lg:px-8 text-center flex flex-col items-center justify-center h-full">
            ...
            <div className="relative">
              ...
              <p className="text-gray-200 text-lg md:text-2xl font-sans font-light leading-relaxed mb-4 drop-shadow-md">
                A product shoot is one of the most effective ways to showcase what you sell and why it matters. Unlike plain catalog images, professional product photography highlights features, details, and quality that build trust with potential buyers.
              </p>
              <p className="text-gray-300 text-xs md:text-sm font-sans font-light tracking-widest uppercase leading-loose max-w-3xl mx-auto">
                From e-commerce and social media to advertisements and brochures, high-quality visuals make your products stand out in a crowded marketplace.
              </p>
