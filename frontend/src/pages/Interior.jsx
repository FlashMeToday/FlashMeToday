...
import interiorHeroImg from '../assets/Images/Business/Interior/HeroBG.webp';
import interiorDetailImg from '../assets/Images/Business/Interior/DetailBG.webp';
import idea1 from '../assets/Images/Business/Interior/1.webp';
import idea2 from '../assets/Images/Business/Interior/2.webp';
import idea3 from '../assets/Images/Business/Interior/3.webp';
import idea4 from '../assets/Images/Business/Interior/4.webp';
import idea5 from '../assets/Images/Business/Interior/5.webp';
import idea6 from '../assets/Images/Business/Interior/6.webp';
import idea7 from '../assets/Images/Business/Interior/7.webp';
import idea8 from '../assets/Images/Business/Interior/8.webp';
import idea9 from '../assets/Images/Business/Interior/9.webp';
import idea10 from '../assets/Images/Business/Interior/10.webp';
import idea11 from '../assets/Images/Business/Interior/11.webp';
import idea12 from '../assets/Images/Business/Interior/12.webp';
import { FaMapMarkerAlt, FaTag, FaRegLightbulb, FaInfoCircle } from 'react-icons/fa';

const interiorPlans = [
  {
    name: "Insta Interior Shoot",
    description: "Photographer Only",
    features: [
      "50 Edited Images",
      "4 Shots Per Rooms",
      "Coverage - Full 3-4 BHK Property (Inner + Outdoor Shots)"
    ],
  ...
  {
    name: "Grand Interior Shoot",
    description: "Photos + Reels",
    features: [
      "50 Edited Images + 2 Reels",
      "4 Shots Per Rooms",
      "Coverage - Full 3-4 BHK Property (Inner + Outdoor Shots)"
    ],
    equipment: "1 Photographer with Full Frame Cameras, Lenses & Lights",
      ...
      <div className="flex flex-col gap-4 md:gap-32">
        <section id="pricing-plans" className="w-full scroll-mt-40 flex flex-col items-center">
          ...
          <div className="w-full max-w-[1600px] mx-auto px-4 lg:px-8">
            <PricingAccordion plans={interiorPlans} serviceName="Interior" />
          </div>
        </section>
        ...
        <section id="details" className="relative w-full h-[50vh] md:h-[55vh] flex items-center justify-center mt-0 md:-mt-20 overflow-hidden scroll-mt-40 z-10">
          <div className="absolute inset-0 w-full h-full bg-black">
            <img loading="lazy" src={interiorDetailImg} alt="Interior Background" className="w-full h-full object-cover opacity-50 transition-transform duration-[10000ms] scale-110 hover:scale-100" />
          </div>
          ...
          <div className="relative z-10 max-w-5xl mx-auto px-4 lg:px-8 text-center flex flex-col items-center justify-center h-full">
            ...
            <div className="relative">
              ...
              <p className="text-gray-200 text-lg md:text-2xl font-sans font-light leading-relaxed mb-4 drop-shadow-md">
                Interior photography transforms spaces into stories. It’s not just about walls and furniture — it’s about capturing the mood, design, and functionality of a space in a way that resonates with viewers.
              </p>
              <p className="text-gray-300 text-xs md:text-sm font-sans font-light tracking-widest uppercase leading-loose max-w-3xl mx-auto">
                Whether for real estate, hotels, offices, or architecture portfolios, professional interior photography highlights the beauty of lighting, structure, and layout.
              </p>
